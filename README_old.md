...
Minimus size 11 Gb Гб удалить сначала раздел с флешки ( опасно пропадут все фаилы ) допустим в программе gnome-disk и флешка должна быть в итоге без фаиловой системы вообще если оставить же fs допустим ntfs на флешке то вы при записи получите не читаемый раздел unknown именно по этому флешка должна быть без любой фаиловой системы

...
Linux install chromium os to usb-flash / micro sd 

Minimus size 11 Gb Гб удалить сначала раздел/ы c различными или одной fs с флешки ( опасно пропадут все фаилы ) допустим в программе gparted и флешка должна быть в итоге без фаиловой системы вообще если оставить же fs допустим ntfs на флешке то вы при записи получите не читаемый раздел unknown именно по этому флешка должна быть без любой фаиловой системы и даже мелкого оставленного кусочка партиции с какой либо fs.

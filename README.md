...
Chromium OS download : http://yadi.sk/d/YDo9_JoDwIb4WQ наконец то включили видео для этой OS хотя бы частично на ютуб ну как бы из за фри софтварности всё равно некоторые видеокодаки html5 может не поддерживать и я постараюсь решить эту проблему , но что нам мешает делать из моей системы мод linux os и за бустрапить туда wine ? Конечно же ничего как и редактирование тех же имеиджев с андроидами так что постепенно  so кодаки можно занести и сделать эту ось с кучей окружении. В любом случае эта ось запатентована и несёт свои отпечаток что скомпилировалась на моей гибридной системе что я создал ранее в отличии от меня на кусок хлеба и масла остальных урвавших мне остается быть в состоянии "заморозка" до раскрытия заговора о имеющем случае явлении как удаление любых комментариев об этом chromium os 77 с этим voice vox на борту на wayland композиторе на территории рф одновременно являясь гражданином рф что является не меньшим доказательством что москва вступила в сговор с какой то корпорацией которая распространяет интернет по основному интеренет кабелю против своего же гражданина рф что бы тот не получил то что они могут получить за него , а это миллирды долларов на переработанном chromium os или даже превращением это в фуксию вырезая определенные лишние модули и пересобирая методом меинфреим бустрапа (про фуксию не точно , но в этом датском королевстве возможно что угодно) проверить вариацию удаления любой информации и ссылки сюда можно распространением этой самой ссылки и проверка ее на выживаемость допустим через неделю более того можно наити дискуссии где возможности что либо упоминуть будут заблокированы по причине выше следующей, возможно причиной яростной зависти ит корпорации явилось наличие полученных методом генерации скругленных углов браузера и раскрываемых элементов и возможность втавить и доставить туда эмулятор для apk опять же это не точно т не возможность уже собрать именно в таком варианте потому что апи самих gcc и llvm уже поменялся и по этой банальной причине уже так же не собрать и вообще не сможет по скольку я делал на той операционной системе которую сам собирал различными методами хака и инженерии если это был заговор дезингеров то это до банального смешно по скольку есть вариант gtk-3 на wx /usr/lib/wx/python touch wx3.0.pth с содержимым wx-3.0-gtk3 с создание ссылки sudo ln -s /usr/lib/wx/python/wx3.0.pth /usr/lib/wx/python/wx.pth. Я могу лишь сказать что 
...
<ytd-thumbnail width="210"     class="style-scope ytd-grid-video-renderer">     <a id="thumbnail"         class="yt-simple-endpoint inline-block style-scope ytd-thumbnail"          aria-hidden="true"         tabindex="-1"         href="/watch?v=MVhZ_QZGxaQ">         <yt-img-shadow class="style-scope ytd-thumbnail no-transition"                  style="background-color: transparent;"             loaded=""><img id="img"                 class="style-scope yt-img-shadow"                 src="https://i.ytimg.com/vi/MVhZ_QZGxaQ/maxresdefault.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&amp;rs=AOn4CLDLYVZCLygsb84jArDAXKk_8ZVhiQ""                          width="210"></yt-img-shadow>         <div id="mouseover-overlay"             class="style-scope ytd-thumbnail"></div>         <div id="overlays"             class="style-scope ytd-thumbnail">             <ytd-thumbnail-overlay-time-status-renderer             class="style-scope ytd-thumbnail" overlay-style="DEFAULT"><span class="style-scope ytd-thumbnail-overlay-time-status-renderer"                                  aria-label=5 минуты 39 секунды">       5:39     </span></ytd-thumbnail-overlay-time-status-renderer>                 <ytd-thumbnail-overlay-toggle-button-renderer                 role="button" tabindex="0"                     class="style-scope ytd-thumbnail"                     aria-label="Watch later">                     <yt-icon class="style-scope ytd-thumbnail-overlay-toggle-button-renderer">                         <svg viewBox="0 0 24 24"                             preserveAspectRatio="xMidYMid meet"                                                  focusable="false"                             style="pointer-events: none; display: block; width: 100%; height: 100%;"                                                  class="style-scope yt-icon">                             <g class="style-scope yt-icon">                                 <path d="M12 3.67c-4.58 0-8.33 3.75-8.33 8.33s3.75 8.33 8.33 8.33 8.33-3.75 8.33-8.33S16.58 3.67 12 3.67zm3.5 11.83l-4.33-2.67v-5h1.25v4.34l3.75 2.25-.67 1.08z"                                                                  class="style-scope yt-icon"></path>                             </g>                         </svg>                     </yt-icon>                     <paper-tooltip id="tooltip"                         class="style-scope ytd-thumbnail-overlay-toggle-button-renderer"                                          role="tooltip"                         tabindex="-1">                         <div id="tooltip"                             class="hidden style-scope paper-tooltip">                             Watch later                         </div>                     </svg>                     </paper-tooltip>                     </ytd-thumbnail-overlay-equalizer>                     </ytd-thumbnail-overlay-toggle-button-renderer>                     <ytd-thumbnail-overlay-loading-preview-renderer class="style-scope ytd-thumbnail">         </div>     </a> </ytd-thumbnail>

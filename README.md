...
видим денег для моих разработок нет , но как поменяется именно подход что корпорации будут выкупать эти разработки , а не просто брать и переписывать lsb мы создали нев итд , тогда конечно ваяться новая система быстрее она же это трудо часы и сильнеишее продумывание , а брать конечно на всброс мы сделали кладите нам донаты , а не создателю корневому то конечно и я и вы простые пользователи будете жестко обмануты желтыми статьями и все такое, хотя кому то может это и нравиться.

...
Грязный конфиг защищенный sandbox копировать и вставлять в терминал                             
...
Очищенный конфиг может иметь кучу новых функции , но по скольку являятся больше веб платформой может быть и более уязвимой по графике 2.0 будет чуть хуже                        

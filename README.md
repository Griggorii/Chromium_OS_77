...
В ходе холивара я сразу указал ещё человека , а то неторые умудряются не утираться своим величием и с помощью лаптей и матрешек доказывать своё превосходство.
